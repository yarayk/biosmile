...
class Lips3 extends StatefulWidget {
  const Lips3({super.key});

  @override
  State<Lips3> createState() => _Lips3State();
}

class _Lips3State extends State<Lips3> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/lips_3_exercises');
                          },
