...
class Lips7 extends StatefulWidget {
  const Lips7({super.key});

  @override
  State<Lips7> createState() => _Lips7State();
}

class _Lips7State extends State<Lips7> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/lips_7_exercises');
                          },
