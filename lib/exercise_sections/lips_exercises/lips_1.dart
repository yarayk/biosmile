...
class Lips1 extends StatefulWidget {
  const Lips1({super.key});

  @override
  State<Lips1> createState() => _Lips1State();
}

class _Lips1State extends State<Lips1> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/lips_1_exercises');
                          },
