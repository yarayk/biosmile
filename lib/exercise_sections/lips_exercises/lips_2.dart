...
class Lips2 extends StatefulWidget {
  const Lips2({super.key});

  @override
  State<Lips2> createState() => _Lips2State();
}

class _Lips2State extends State<Lips2> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/lips_2_exercises');
                          },
