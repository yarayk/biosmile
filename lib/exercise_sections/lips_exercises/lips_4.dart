...
class Lips4 extends StatefulWidget {
  const Lips4({super.key});

  @override
  State<Lips4> createState() => _Lips4State();
}

class _Lips4State extends State<Lips4> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/lips_4_exercises');
                          },
