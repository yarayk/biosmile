...
class Lips6 extends StatefulWidget {
  const Lips6({super.key});

  @override
  State<Lips6> createState() => _Lips6State();
}

class _Lips6State extends State<Lips6> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/lips_6_exercises');
                          },
