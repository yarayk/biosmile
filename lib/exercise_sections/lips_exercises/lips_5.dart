...
class Lips5 extends StatefulWidget {
  const Lips5({super.key});

  @override
  State<Lips5> createState() => _Lips5State();
}

class _Lips5State extends State<Lips5> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/lips_5_exercises');
                          },
