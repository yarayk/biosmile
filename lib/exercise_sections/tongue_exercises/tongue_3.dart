...
class Tongue3 extends StatefulWidget {
  const Tongue3({super.key});

  @override
  State<Tongue3> createState() => _Tongue3State();
}

class _Tongue3State extends State<Tongue3> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/tongue_3_exercises');
                          },
