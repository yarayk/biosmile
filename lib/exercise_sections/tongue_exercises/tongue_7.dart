...
class Tongue7 extends StatefulWidget {
  const Tongue7({super.key});

  @override
  State<Tongue7> createState() => _Tongue7State();
}

class _Tongue7State extends State<Tongue7> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/tongue_7_exercises');
                          },
