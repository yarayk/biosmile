...
class Tongue6 extends StatefulWidget {
  const Tongue6({super.key});

  @override
  State<Tongue6> createState() => _Tongue6State();
}

class _Tongue6State extends State<Tongue6> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/tongue_6_exercises');
                          },
