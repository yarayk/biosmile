...
class Tongue5 extends StatefulWidget {
  const Tongue5({super.key});

  @override
  State<Tongue5> createState() => _Tongue5State();
}

class _Tongue5State extends State<Tongue5> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/tongue_5_exercises');
                          },
