...
class Tongue2 extends StatefulWidget {
  const Tongue2({super.key});

  @override
  State<Tongue2> createState() => _Tongue2State();
}

class _Tongue2State extends State<Tongue2> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/tongue_2_exercises');
                          },
