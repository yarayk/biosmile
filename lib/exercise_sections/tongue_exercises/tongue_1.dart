...
class Tongue1 extends StatefulWidget {
  const Tongue1({super.key});

  @override
  State<Tongue1> createState() => _Tongue1State();
}

class _Tongue1State extends State<Tongue1> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/tongue_1_exercises');
                          },
