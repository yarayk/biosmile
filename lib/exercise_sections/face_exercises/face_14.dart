...
class Face14 extends StatefulWidget {
  const Face14({super.key});

  @override
  State<Face14> createState() => _Face14State();
}

class _Face14State extends State<Face14> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/face_14_exercises');
                          },
