...
class Face15 extends StatefulWidget {
  const Face15({super.key});

  @override
  State<Face15> createState() => _Face15State();
}

class _Face15State extends State<Face15> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/face_15_exercises');
                          },
