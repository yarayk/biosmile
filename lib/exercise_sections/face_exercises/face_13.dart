...
class Face13 extends StatefulWidget {
  const Face13({super.key});

  @override
  State<Face13> createState() => _Face13State();
}

class _Face13State extends State<Face13> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/face_13_exercises');
                          },
