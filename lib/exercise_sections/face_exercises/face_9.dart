...
class Face9 extends StatefulWidget {
  const Face9({super.key});

  @override
  State<Face9> createState() => _Face9State();
}

class _Face9State extends State<Face9> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/face_9_exercises');
                          },
