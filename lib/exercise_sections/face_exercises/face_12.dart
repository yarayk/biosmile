...
class Face12 extends StatefulWidget {
  const Face12({super.key});

  @override
  State<Face12> createState() => _Face12State();
}

class _Face12State extends State<Face12> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/face_12_exercises');
                          },
