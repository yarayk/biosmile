...
class Face3 extends StatefulWidget {
  const Face3({super.key});

  @override
  State<Face3> createState() => _Face3State();
}

class _Face3State extends State<Face3> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/face_3_exercises');
                          },
