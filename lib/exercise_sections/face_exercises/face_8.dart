...
class Face8 extends StatefulWidget {
  const Face8({super.key});

  @override
  State<Face8> createState() => _Face8State();
}

class _Face8State extends State<Face8> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/face_8_exercises');
                          },
