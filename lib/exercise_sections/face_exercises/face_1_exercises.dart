...
class _Face1ExercisesState extends State<Face1Exercises> {
  ...
  void connectWebSocket() {
    ...
    channel.stream.listen((message) {
      ...
      if (decoded["status"] == "tracking" && decoded["delta"] != null) {
        ...
        if (maxLiftRatio > 0) {
          double threshold = maxLiftRatio * 0.9;
          ...
          if (currentLift >= threshold && !browAboveThreshold && wasLoweredBeforeLift) {
  ...
  void processCameraImage(CameraImage image) async {
    ...
    final data = jsonEncode({"mode": "track", "exercise": "face_1", "image": base64Image});
  ...
  void sendInit() async {
    ...
    final data = jsonEncode({"mode": "init", "exercise": "face_1", "image": base64Image});
    channel.sink.add(data);
  }
