...
class Face4 extends StatefulWidget {
  const Face4({super.key});

  @override
  State<Face4> createState() => _Face4State();
}

class _Face4State extends State<Face4> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/face_4_exercises');
                          },
