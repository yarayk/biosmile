...
class Face10 extends StatefulWidget {
  const Face10({super.key});

  @override
  State<Face10> createState() => _Face10State();
}

class _Face10State extends State<Face10> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/face_10_exercises');
                          },
