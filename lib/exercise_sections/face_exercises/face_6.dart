...
class Face6 extends StatefulWidget {
  const Face6({super.key});

  @override
  State<Face6> createState() => _Face6State();
}

class _Face6State extends State<Face6> {
          ...
          children: [
            ...
            Column(
              children: [
                ...
                const Text(
                  'Прищуривайся, подтягивая нижнее веко',
                  style: TextStyle(
                    fontSize: 18,
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/face_6_exercises');
                          },
