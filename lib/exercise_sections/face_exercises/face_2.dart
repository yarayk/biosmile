...
class Face2 extends StatefulWidget {
  const Face2({super.key});

  @override
  State<Face2> createState() => _Face2State();
}

class _Face2State extends State<Face2> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/face_2_exercises');
                          },
