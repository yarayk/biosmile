...
class Face7 extends StatefulWidget {
  const Face7({super.key});

  @override
  State<Face7> createState() => _Face7State();
}

class _Face7State extends State<Face7> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/face_7_exercises');
                          },
