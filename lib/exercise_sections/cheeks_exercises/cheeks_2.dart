...
class Cheeks2 extends StatefulWidget {
  const Cheeks2({super.key});

  @override
  State<Cheeks2> createState() => _Cheeks2State();
}

class _Cheeks2State extends State<Cheeks2> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/cheeks_2_exercises');
                          },
