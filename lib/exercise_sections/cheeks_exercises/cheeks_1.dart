...
class Cheeks1 extends StatefulWidget {
  const Cheeks1({super.key});

  @override
  State<Cheeks1> createState() => _Cheeks1State();
}

class _Cheeks1State extends State<Cheeks1> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/cheeks_1_exercises');
                          },
