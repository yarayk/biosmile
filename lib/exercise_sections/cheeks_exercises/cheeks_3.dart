...
class Cheeks3 extends StatefulWidget {
  const Cheeks3({super.key});

  @override
  State<Cheeks3> createState() => _Cheeks3State();
}

class _Cheeks3State extends State<Cheeks3> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/cheeks_3_exercises');
                          },
