...
class TongueExercisesPage extends StatefulWidget {
  const TongueExercisesPage({super.key});

  @override
  State<TongueExercisesPage> createState() => _TongueExercisesPageState();
}

class _TongueExercisesPageState extends State<TongueExercisesPage> {
  // ===== Figma frame =====
  static const double _designW = 375.0;
  static const double _designH = 1073.0;
  ...
  static const List<_ExerciseMeta> exercises = [
    _ExerciseMeta(number: 1, title: 'Открыть рот, язык поднять, опустить', route: '/tongue_1'),
    _ExerciseMeta(number: 2, title: 'Рот открыт, язык вверх-вниз', route: '/tongue_2'),
    _ExerciseMeta(number: 3, title: 'Рот открыть, язык к правому уху, к левому', route: '/tongue_3'),
    _ExerciseMeta(number: 4, title: 'Облизать нижнюю, затем верхнюю губу', route: '/tongue_4'),
    _ExerciseMeta(number: 5, title: 'Облизать губы по кругу', route: '/tongue_5'),
    _ExerciseMeta(number: 6, title: 'Языком погладить твердое небо', route: '/tongue_6'),
    _ExerciseMeta(number: 7, title: 'Длинное задание', route: '/tongue_7'),
  ];

  // ===== Nodes positions (CSS) =====
  static const List<_ExerciseNode> nodes = [
    _ExerciseNode(number: 1, route: '/tongue_1', x: 144, y: 149),
    _ExerciseNode(number: 2, route: '/tongue_2', x: 55,  y: 320),
    _ExerciseNode(number: 3, route: '/tongue_3', x: 233, y: 320),
    _ExerciseNode(number: 4, route: '/tongue_4', x: 144, y: 491),
    _ExerciseNode(number: 5, route: '/tongue_5', x: 55,  y: 662),
    _ExerciseNode(number: 6, route: '/tongue_6', x: 233, y: 662),
    _ExerciseNode(number: 7, route: '/tongue_7', x: 144, y: 833),
  ];
