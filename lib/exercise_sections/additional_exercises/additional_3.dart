...
class Additional3 extends StatefulWidget {
  const Additional3({super.key});

  @override
  State<Additional3> createState() => _Additional3State();
}

class _Additional3State extends State<Additional3> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/additional_3_exercises');
                          },
