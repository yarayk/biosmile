...
class Additional1 extends StatefulWidget {
  const Additional1({super.key});

  @override
  State<Additional1> createState() => _Additional1State();
}

class _Additional1State extends State<Additional1> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/additional_1_exercises');
                          },
