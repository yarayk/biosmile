...
class Additional2 extends StatefulWidget {
  const Additional2({super.key});

  @override
  State<Additional2> createState() => _Additional2State();
}

class _Additional2State extends State<Additional2> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/additional_2_exercises');
                          },
