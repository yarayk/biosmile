...
class Additional4 extends StatefulWidget {
  const Additional4({super.key});

  @override
  State<Additional4> createState() => _Additional4State();
}

class _Additional4State extends State<Additional4> {
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/additional_4_exercises');
                          },
