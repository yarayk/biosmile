...
class AdditionalExercisesPage extends StatefulWidget {
  const AdditionalExercisesPage({super.key});

  @override
  State<AdditionalExercisesPage> createState() => _AdditionalExercisesPageState();
}

class _AdditionalExercisesPageState extends State<AdditionalExercisesPage> {
  // ===== Figma frame =====
  static const double _designW = 375.0;
  static const double _designH = 768.0;
  ...
  // ===== Assets =====
  static const String roadBgAsset = 'assets/exercise/fon1_2.png';
  ...
  static const List<_ExerciseMeta> exercises = [
    ...
    _ExerciseMeta(number: 2, title: 'Брать с ладони мелкие куски яблока', route: '/additional_2'),
    _ExerciseMeta(number: 3, title: 'Вибрация губ (Фыркать)', route: '/additional_3'),
    _ExerciseMeta(number: 4, title: 'Длинное задание', route: '/additional_4'),
  ];

  // ===== Nodes positions (CSS) =====
  static const List<_ExerciseNode> nodes = [
    _ExerciseNode(number: 1, route: '/additional_1', x: 144, y: 149),
    _ExerciseNode(number: 2, route: '/additional_2', x: 55,  y: 320),
    _ExerciseNode(number: 3, route: '/additional_3', x: 233, y: 320),
    _ExerciseNode(number: 4, route: '/additional_4', x: 144, y: 491),
  ];
    ...
    return Positioned(
      ...
      child: ClipRect(
        child: BackdropFilter(
          ...
          child: Container(
            color: const Color(0xFF8FB6EA).withAlpha((0.35 * 255).round()),
            child: Stack(
              children: [
                Positioned(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      extendBody: true,
      backgroundColor: const Color(0xFF8FB6EA),
      body: SafeArea(
        top: false,
        bottom: false,
        child: LayoutBuilder(
